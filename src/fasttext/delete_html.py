...
'''
created by lidongsheng004 from web 2018/09/18
下面几段代码都是过滤html文件的标签用的，经测试，strip_tags()最好用
'''
...
if __name__=='__main__':
    #delete_result = open("delete_tag.txt",'w')
    result = []
    resultwa = []
    filters = FilterTag()
    # with open('过审文章.csv', 'r') as f:
    #  for line in f.readlines():
    #       print filters.filterHtmlTag(line).replace("\n","")
